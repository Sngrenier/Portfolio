...
export default class MarbleOak extends Component {
    render() {
        ...
        style={true}
      />
      {/* <iframe width="1260" height="715" src="https://www.youtube.com/embed/N6tywPqODnc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> */}
    </div>
