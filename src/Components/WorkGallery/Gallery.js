            ...
            <div className="container-fluid">
                ...
                <div className="bkgrd-left-work"></div>
                    ...
                    <div className="gallery-info">
                        ...
                        <div className="first-column">
                            ...
                            {/* <div className="project">
                            <Link to='/vulgr'>
                            <div className="proj-pic"><img alt="" className="proj-icon" src="https://scontent-sjc3-1.xx.fbcdn.net/v/t1.6435-9/202131588_10110599023274248_5035917576920223239_n.jpg?_nc_cat=111&ccb=1-3&_nc_sid=0debeb&_nc_ohc=6ZZvLvueChUAX9vMDNn&_nc_ht=scontent-sjc3-1.xx&oh=4f319e9bf038b164b71de07ba3099d3e&oe=60DA8F88"></img></div>
                            </Link>
                            <ul className="proj-deets">
                                <Link to='/vulgr'>
                ...
                <div className="column second-column">
                        <div className="second-column">
                            ...
                            <Link to='/gcakes'>
                            <div className="proj-pic">
                                <img alt="" className="proj-icon" src="https://scontent-sjc3-1.xx.fbcdn.net/v/t1.6435-9/204527415_10110599252943988_2763670646160967779_n.jpg?_nc_cat=108&ccb=1-3&_nc_sid=0debeb&_nc_ohc=14p_WJjPJjwAX_YaMLi&_nc_ht=scontent-sjc3-1.xx&oh=535b4bf527f2a6b5a1cb9a53d1f13eff&oe=60DA7946"></img></div>
                                </Link>
                            <ul className="proj-deets">
                                <Link to='/gcakes'>
                ...
                <div className="column third-column">
                        <div className="third-column">
                            ...
                            {/* <div className="project">
                            <Link to='limelemons'>
                            <div className="proj-pic"><img alt="" className="proj-icon" src="https://scontent-sjc3-1.xx.fbcdn.net/v/t1.6435-9/203078804_10110599267684448_6074898303149594391_n.jpg?_nc_cat=101&ccb=1-3&_nc_sid=0debeb&_nc_ohc=gzhljZidYxMAX_vmODI&_nc_ht=scontent-sjc3-1.xx&oh=69e8fbeb93c7dd74efc3ce1fecf7d459&oe=60DB4C38"></img></div>
                            </Link>
                            <ul className="proj-deets">
                                <Link to='/limelemons'>
