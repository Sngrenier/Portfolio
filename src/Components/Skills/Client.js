                    ...
                    <div className="bkgrd-right3">
                        <div className="client-details">
                            ...
                            <div className="client-para">
                                ...
                                <p className="indv-para">I’m so excited to start my new burgeoning career that now includes web development! It allows me to create and build, two of my favorite things, while utilizing my communication, leadership, and experiential skills from my previous career.  My work experience created a unique skillset which allows me to speak the language of multiple stakeholders, and thus to execute on a level not normally done by one person. So let's build something beautiful together! </p>
                            </div>
                        </div>
