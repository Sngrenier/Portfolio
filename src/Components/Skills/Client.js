                    ...
                    <div className="bkgrd-right3">
                        <div className="client-details">
                            ...
                            <div className="client-para">
                                <p className="inv-para">I have 15 years of luxury and contemporary luxury management experience.  I have trained and led successful sales teams, managed comprehensive sales figures and budget analysis, and have moved entire store spaces.  I have also designed brand experiences, client journeys, store layouts, and large-scale visual merchandising installations among allll the other things that go into luxury retail management.  I’m also a former Division One soccer player who loves art and textiles as much as a comeback win. </p>
                                <p className="inv-para">I’m so excited to start my new burgeoning new career in web development and design. It allows me to build and create, two of my favorite things, while utilizing my communication, leadership, and experiential skills from my previous career.  My work experience created a unique skillset which allows me to speak the language of multiple stakeholders, and thus to execute on a level not normally done by one person. </p>
                                <p className="inv-para">Currently I’m working on freelance brand and web development projects with small business’, including Edible magazine online publication.  I’ve also worked on freelance work for packaging design, logo design, web design, and brand development for several companies, some are highlighted in my projects page.  </p>
