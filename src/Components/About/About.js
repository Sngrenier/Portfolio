                    ...
                    <div className="bkgrd-right2">
                        <div className="about-details">
                            ...
                            <div className="about-para">
                                <p className="inv-para">{<><strong>Hi-ya!  I’m Stacy, and I’m thrilled that you are taking time to learn more about me.</strong> I’m a full-stack web developer, web designer and graphic designer with experience in complete brand development & packaging design. </>}</p> 
